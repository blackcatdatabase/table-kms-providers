...
> Lineage: 0 outbound / 2 inbound · ✅ No engine drift detected · Index coverage: ready · PII flags: 1 · Changelog: fresh (18 d)
...
| Pkg folder | [packages\kms-providers](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\kms-providers) | Repo location |
...
pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package kms-providers -Apply
