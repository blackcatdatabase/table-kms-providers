...
namespace BlackCat\Database\Packages\KmsProviders\Mapper;

use BlackCat\Database\Packages\KmsProviders\Dto\KmsProviderDto;
use BlackCat\Database\Packages\KmsProviders\Definitions;
use DateTimeZone;
use BlackCat\Database\Support\DtoHydrator;

/**
 * Bidirectional mapper between DB rows and DTO KmsProviderDto:
...
final class KmsProviderDtoMapper
{
     ...
     * @return KmsProviderDto
     */
    public static function fromRow(array $row): KmsProviderDto
    {
        /** @var KmsProviderDto */
        return DtoHydrator::fromRow(
            KmsProviderDto::class,
            $row,
            self::COL_TO_PROP,
            self::BOOL_COLS,
            self::INT_COLS,
    ...
    public static function fromRowOrNull(?array $row): ?KmsProviderDto
    {
     ...
     *
     * @param KmsProviderDto   $dto
     * @param string[]|null   $onlyProps  optional whitelist of DTO properties to serialize
     * @return array<string,mixed>
     */
    public static function toRow(KmsProviderDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(KmsProviderDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(KmsProviderDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
     ...
     * @return array<int,KmsProviderDto>
     */
    public static function hydrateList(array $rows): array
    {
        /** @var array<int,KmsProviderDto> */
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(KmsProviderDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,KmsProviderDto>
     */
