...
final class KmsProviderRepository implements RepoContract {
    ...
    public function insert(array $row): void {
        ...
        $tblEsc  = $isMysql ? '`kms_providers`' : '"kms_providers"';
     ...
     * [ 'name' ] = unikátní klíče (sloupce) pro konflikty,
     * [ 'provider', 'location', 'project_tenant', 'is_enabled' ] = které sloupce aktualizovat.
     */
    public function upsert(array $row): void {
        ...
        $keys = [ 'name' ];
        $upd  = [ 'provider', 'location', 'project_tenant', 'is_enabled' ];
