...
final class KmsProvidersModule implements ModuleInterface
{
    public function name(): string { return 'table-kms_providers'; }
    public function table(): string { return 'kms_providers'; }
    ...
    public function status(Database $db, SqlDialect $d): array
    {
        ...
        $expectedIdx = [ 'ux_kms_providers_name' ];
        $expectedFk  = [];
