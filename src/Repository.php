...
use BlackCat\Database\Packages\KmsProviders\Repository\KmsProviderRepository as GeneratedRepository;
...
{
  private KmsProviderRepositoryInterface $repo;
  ...
  public function __construct(private Database $db)
  {
    ...
    public function _setRepositoryForTests(RepoContract $repo): void
    {
        ...
        if (!$repo instanceof KmsProviderRepositoryInterface) {
            // Allow any repo that conforms to the interface even if not generated
            throw new \InvalidArgumentException('Expected KmsProviderRepositoryInterface');
        }
        $this->repo = $repo;
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\KmsProviders\Dto\KmsProviderDto|null { return $this->repo->getByUnique($keys, $asDto); }
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\KmsProviders\Dto\KmsProviderDto|null { return $this->repo->getById($id, $asDto); }
