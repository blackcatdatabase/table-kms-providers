...
use BlackCat\Database\Packages\KmsProviders\Repository\KmsProviderRepository;
...
{
    private KmsProviderRepository $repo;

    public function __construct(private Database $db)
    {
        $this->repo = new KmsProviderRepository($db);
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\KmsProviders\Dto\KmsProviderDto|null
    {
        return $this->repo->getByUnique($keys, $asDto);
    }

    /** @return array<string,mixed>|\BlackCat\Database\Packages\KmsProviders\Dto\KmsProviderDto|null */
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\KmsProviders\Dto\KmsProviderDto|null
    {
